...
def is_possible_game(cube_counts, revealed_sets):
    possible = True
...
def possible_games_sum(cube_counts, games):
    ...
    for game in games:
        ...
        if is_possible_game(cube_counts, revealed_sets):
...
input = open("challenge2.txt", "r")
# Target cube counts
target_cube_counts = [12, 13, 14]

# Calculate the sum of IDs of possible games
result = possible_games_sum(target_cube_counts, input)
